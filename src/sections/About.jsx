      ...
      <div className="container">
        <div className="about-grid">
          <div className="about-left">
            ...
            <div className="about-lotties reveal">
              <DotLottieReact src="/golf-green.lottie" loop autoplay className="about-golf-lottie" />
              <DotLottieReact src="/food-prep.lottie"  loop autoplay className="about-food-lottie" />
            </div>
          </div>
